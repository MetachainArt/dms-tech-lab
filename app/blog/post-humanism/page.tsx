...
import { ArrowLeft, Clock, Calendar, Share2, Bookmark, Skull, Heart, Dna, Cpu, Brain, Zap, Fingerprint } from "lucide-react";
      ...
      <section className="relative px-6 py-20">
        <div className="max-w-3xl mx-auto">
            <article className="prose prose-lg prose-invert prose-p:text-gray-300 prose-headings:text-white max-w-none font-serif">
                ...
                <h2 className="text-3xl font-sans font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-pink-500 mb-8 mt-16">
                ...
                <h2 className="text-3xl font-sans font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500 mb-8 mt-16">
                ...
                <h2 className="text-3xl font-sans font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-500 mb-8 mt-16">
            ...
            {/* Reedo Author Component */}
             <div className="mt-24 p-8 rounded-2xl bg-[#0A1124] border border-white/10 flex items-center gap-6 shadow-2xl relative overflow-hidden group hover:border-pink-500/30 transition-colors">
                ...
                <div className="flex-grow relative z-10">
                    <h3 className="text-xl font-bold text-white mb-1 group-hover:text-pink-400 transition-colors">Written by Reedo</h3>
                    ...
                    <p className="text-gray-500 text-xs leading-relaxed max-w-md">
                        우리는 기술을 만들고, 기술은 다시 우리를 만듭니다. 그 순환의 고리 속에서 인간의 의미를 찾습니다.
                    </p>
                </div>
