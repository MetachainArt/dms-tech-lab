...
import { ArrowLeft, ArrowRight, Clock, Calendar, Share2, Bookmark, Box, Grid, Hexagon, Layers, Cpu, Network } from "lucide-react";
      ...
      <section className="relative px-6 py-20">
        <div className="max-w-3xl mx-auto">
            <article className="prose prose-lg prose-invert prose-p:text-gray-300 prose-headings:text-white max-w-none font-serif">
                ...
                <h2 className="text-3xl font-sans font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-500 mb-8 mt-16">
                ...
                <h2 className="text-3xl font-sans font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 mb-8 mt-16">
             ...
             <div className="mt-24 p-8 rounded-2xl bg-[#0A1124] border border-white/10 flex items-center gap-6 shadow-2xl relative overflow-hidden group hover:border-cyan-500/30 transition-colors">
                ...
                <div className="flex-grow relative z-10">
                    ...
                    <p className="text-gray-500 text-xs leading-relaxed max-w-md">
                        AI와 인간의 공진화를 탐구합니다. 기술적 깊이와 인문학적 시선을 통해 우리가 마주할 내일을 그립니다.
                    </p>
                </div>
