          ...
          <div className="glass-panel rounded-2xl p-8 overflow-hidden">
            <div className="flex flex-col lg:flex-row gap-8 items-center">
              ...
              <div className="lg:w-2/3 w-full">
                <div className="relative w-full h-[300px] lg:h-[400px] rounded-xl overflow-hidden bg-gradient-to-br from-[#1a1a3f] to-[#0a0a1f] border border-white/10">
                  {/* Decorative Grid */}
                  <div 
                    ...
                    >
                      ...
                      <div className="relative z-10 flex flex-col items-center">
                        <motion.div
                          ...
                          className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg shadow-blue-500/30"
                        >
                  ...
                  <div className="absolute top-4 right-4 w-8 h-8 border-r-2 border-t-2 border-blue-500/30" />
                  <div className="absolute bottom-4 left-4 w-8 h-8 border-l-2 border-b-2 border-blue-500/30" />
