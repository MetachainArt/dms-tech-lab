...
export interface AutomationTemplate {
  ...
  icons: string[]; // List of icon names or types
  detail: {
    lastUpdate: string;
...
export const AUTOMATION_TEMPLATES: AutomationTemplate[] = [
  ...
  "nodes": [
    {
      "parameters": {
        "content": "## 1. 기획 & 아이디어 (Planning)\\n- 매일 09:00 (KST) 실행\\n- 주제 1~8번 순환 로직\\n- **SEO 최적화 (플랫폼별 태그/캡션 분리)**",
        "height": 420,
        "width": 1088,
        "color": 4
      },
      ...
      "id": "14e54bca-984a-4e05-9596-331aff767b2c",
      "name": "메모: 기획 단계"
    },
    {
      "parameters": {
        "content": "## 2. 영상 생성 (Generation)\\n- Sora2 영상 생성 요청\\n- **10분 대기 **\\n- MP4 영상 다운로드",
        "height": 340,
        "width": 1084,
        "color": 3
      },
      ...
      "id": "8c5a5f75-0b55-43c8-baee-dcbaf42cf200",
      "name": "메모: 영상 생성"
    },
    {
      "parameters": {
        "content": "## 4. 배포 & 로그 (Distribution)\\n- 유튜브 (SEO 태그 적용)\\n- 인스타 릴스 (Dropbox 직링크 사용)\\n- **틱톡: 시트에 별도 태그 저장 (Zapier 연동용)**",
        "height": 560,
        "width": 1084,
        "color": 5
      },
      ...
      "id": "52794ebc-ffb7-495c-9b96-89af99619c11",
      "name": "메모: 배포 및 저장"
    },
    {
      "name": "스케줄 (매일 09:00)",
      ...
      "typeVersion": 1.2,
      "position": [-6288, 128],
      "id": "428b39e2-2170-41fe-9f09-3db4de8b1d9d"
    },
    {
      "name": "아이디어 에이전트 (SEO)",
      ...
      "typeVersion": 1.7,
      "position": [-5904, 192],
      "id": "d4225e96-7835-4a2c-a268-f1ad08e2fcd3"
    },
    {
      "name": "유튜브 업로드",
      ...
      "typeVersion": 1,
      "position": [-6000, 1696],
      "id": "875f35a4-8bdc-4223-a0aa-414989faa463"
    }
  ],
  "connections": {}
}`
