      ...
      <ul className="space-y-2.5">
        {[
          ...
          <li key={item} className="flex items-start gap-2.5">
            ...
            <span className="text-sm leading-6 text-[#1e3a5f]">{item}</span>
          </li>
        ))}
      </ul>
      ...
      <ul className="space-y-2.5">
        {[
          ...
          <li key={item} className="flex items-start gap-2.5">
            ...
            <span className="text-sm leading-6 text-[#14532d]">{item}</span>
          </li>
        ))}
      </ul>
...
다음 편에서는 이번 업데이트의 `requireApproval` 훅을 실제로 설정하고, 텔레그램 버튼으로 승인받는 흐름을 직접 만들어봅니다.
