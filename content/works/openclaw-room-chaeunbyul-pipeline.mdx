---
title: "4편 에이전트의 몸 — 다중 환경 자동화 파이프라인"
...
**둘째 — 단순한 방법이 항상 옳지는 않다**. kie.ai 같은 이미지 API를 쓰면 ComfyUI 연동 없이 바로 이미지 URL을 받을 수 있습니다. 훨씬 단순합니다. 하지만 로컬 ComfyUI를 연동하는 것은 **다양한 환경을 유기적으로 연결하는 능력**을 기르기 위한 의도적인 선택이었습니다. 비용도 절감되고 커스터마이즈도 자유롭습니다.
